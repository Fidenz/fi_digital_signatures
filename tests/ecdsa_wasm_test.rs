...
pub fn ec256_signing_and_verifying() {
    let sig_result = sign(
        ...
        P256SigningKey::from_pem(PRIVATE_KEY_256),
        Algorithm::ES256,
    );
    ...
    assert!(match verify(
        String::from(EC256_CONTENT),
        signature,
        P256VerifyingKey::from_pem(PUBLIC_KEY_256),
        Algorithm::ES256
    ) {
        Ok(val) => val,
        Err(error) => {
...
pub fn ec384_signing_and_verifying() {
    let sig_result = sign(
        ...
        P384SigningKey::from_pem(PRIVATE_KEY_384),
        Algorithm::ES384,
    );
    ...
    assert!(match verify(
        String::from(EC384_CONTENT),
        signature,
        P384VerifyingKey::from_pem(PUBLIC_KEY_384),
        Algorithm::ES384
    ) {
        Ok(val) => val,
        Err(error) => {
...
pub fn ec512_signing_and_verifying() {
    let sig_result = sign(
        ...
        P512SigningKey::from_pem(PRIVATE_KEY_512),
        Algorithm::ES512,
    );
    ...
    assert!(match verify(
        String::from(EC512_CONTENT),
        signature,
        P512VerifyingKey::from_pem(PUBLIC_KEY_512),
        Algorithm::ES512
    ) {
        Ok(val) => val,
        Err(error) => {
...
pub fn ec256k_signing_and_verifying() {
    let sig_result = sign(
        ...
        P256kSigningKey::from_pem(PRIVATE_KEY_256K),
        Algorithm::ES256K,
    );
    ...
    assert!(match verify(
        String::from(EC256K_CONTENT),
        signature,
        P256kVerifyingKey::from_pem(PUBLIC_KEY_256K),
        Algorithm::ES256K
    ) {
        Ok(val) => val,
        Err(error) => {
...
pub fn ec256_hex_signing_and_verifying() {
    let sig_result = sign(
        String::from(EC256_CONTENT),
        P256SigningKey::from_bytes(&hex::decode(PRIVATE_KEY_256_HEX).unwrap().as_slice()),
        Algorithm::ES256,
    );
    ...
    assert!(match verify(
        String::from(EC256_CONTENT),
        signature,
        P256VerifyingKey::from_bytes(hex::decode(PUBLIC_KEY_256_HEX).unwrap().as_slice()),
        Algorithm::ES256
    ) {
        Ok(val) => val,
        Err(error) => {
...
pub fn ec384_hex_signing_and_verifying() {
    let sig_result = sign(
        String::from(EC384_CONTENT),
        P384SigningKey::from_bytes(&hex::decode(PRIVATE_KEY_384_HEX).unwrap().as_slice()),
        Algorithm::ES384,
    );
    ...
    assert!(match verify(
        String::from(EC384_CONTENT),
        signature,
        P384VerifyingKey::from_bytes(hex::decode(PUBLIC_KEY_384_HEX).unwrap().as_slice()),
        Algorithm::ES384
    ) {
        Ok(val) => val,
        Err(error) => {
...
pub fn ec512_hex_signing_and_verifying() {
    let sig_result = sign(
        String::from(EC512_CONTENT),
        P512SigningKey::from_bytes(&hex::decode(PRIVATE_KEY_512_HEX).unwrap().as_slice()),
        Algorithm::ES512,
    );
    ...
    assert!(match verify(
        String::from(EC512_CONTENT),
        signature,
        P512VerifyingKey::from_bytes(hex::decode(PUBLIC_KEY_512_HEX).unwrap().as_slice()),
        Algorithm::ES512
    ) {
        Ok(val) => val,
        Err(error) => {
