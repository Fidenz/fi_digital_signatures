...
fn get_private_key_components() -> [BigUint; 5] {
    [BigUint::from_str("").unwrap(),
    BigUint::from_str("65537").unwrap(),
    BigUint::from_str("").unwrap(),
    BigUint::from_str("").unwrap(),
    BigUint::from_str("").unwrap()]
}
