...
pub fn ec_384_sign(message: String, key: String) -> Result<String, Error> {
    let mut ec_key = match key.starts_with("-----BEGIN EC PRIVATE KEY-----") {
        true => {
...
pub fn ec_384_verify(message: String, sig: String, key: String) -> Result<bool, Error> {
